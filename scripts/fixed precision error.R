...
fit1 <- gamlss(y~x1+x2,~z1,family = BP(mu.link = "log", sigma.link = "log"), trace=FALSE)

#Estimate model - incorrect specification  
fit2 <- gamlss(y~x1+x2,family = BP(mu.link = "log", sigma.link = "log"), trace=FALSE)
...
plot.BP(fit1, which = 1, type = "quantile" is_application=F) 
plot.BP(fit1, which = 1, type = "pearson")
plot.BP(fit1, which = 1, type = "pearson P")
plot.BP(fit1, which = 1, type = "sweighted1")
plot.BP(fit1, which = 1, type = "sweighted2")
plot.BP(fit1, which = 1, type = "variance")
plot.BP(fit1, which = 1, type = "combined")
plot.BP(fit1, which = 1, type = "deviance")
plot.BP(fit1, which = 1, type = "anscombe")
plot.BP(fit1, which = 1, type = "williams")
...
plot.BP(fit2, which = 1, type = "quantile" is_application=F) 
plot.BP(fit2, which = 1, type = "pearson")
plot.BP(fit2, which = 1, type = "pearson P")
plot.BP(fit2, which = 1, type = "sweighted1")
plot.BP(fit2, which = 1, type = "sweighted2")
plot.BP(fit2, which = 1, type = "variance")
plot.BP(fit2, which = 1, type = "combined")
plot.BP(fit2, which = 1, type = "deviance")
plot.BP(fit2, which = 1, type = "anscombe")
plot.BP(fit2, which = 1, type = "williams")
