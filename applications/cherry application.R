...
plot.BP(fit4, which = 1, type = "quantile", is_application=T, q1=-2, q2=2, pos1 = c(2,3), pos2 = c(3), cex.lab=1.5)
plot.BP(fit4, which = 2, type = "quantile", is_application=T, q1-2, q2=2, pos1 = c(2,3), pos2 = c(3), cex.lab=1.5)
plot.BP(fit4, which = 3, type = "quantile", is_application=T, q1=-2, q2=2, pos1 = c(2,3), pos2 = c(3), cex.lab=1.5)
plot.BP(fit4, which = 4, type = "quantile", is_application=T, q1=-2, q2=2, pos1 = c(2,3), pos2 = c(1), cex.lab=1.5)
